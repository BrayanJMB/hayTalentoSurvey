    ...
    public class ModelSurvey
    {
        ...
        private static List<Pregunta> PreguntaMercadeo5()
        {
            var Preguntas = new List<Pregunta>
            {
                 ...
                 new Pregunta {NombrePregunta = "¿Cuánto gastó su empresa en total en beneficios en el último año fiscal?", NumeroPregunta = 2, TipoPregunta = "Selección", Opciones = OpcionesLikkertper16()},
                 new Pregunta {NombrePregunta = "¿Los empleados valoran su plan de beneficios?", NumeroPregunta = 3, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿El plan de beneficios mejora la atracción y retención?", NumeroPregunta = 4, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿El plan de beneficios mejora el compromiso del empleado con su trabajo?", NumeroPregunta = 5, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿El plan de beneficios moviliza el desempeño?", NumeroPregunta = 6, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta="¿Beneficios a la carta (escogencia de acuerdo con portafolio de productos)?", NumeroPregunta = 7, TipoPregunta = "Likkert",Opciones=OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Modelo de compensación flexible?", NumeroPregunta = 8, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {
                     NombrePregunta="¿Beneficio institucional (ej. Descuento en compra de productos de la compañía o entrega a cero costos?",
                     NumeroPregunta=9,
                     TipoPregunta="Likkert",
                     Opciones=OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Planes de ahorro contributivo?", NumeroPregunta = 10, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Pólizas de Seguros (Vida, Asistencia Médica Domiciliaria, otras)?", NumeroPregunta = 11, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta="¿Tiempo libre recompensado (día de cumpleaños, tarde libre los viernes, 24 / 31 diciembre y miércoles santo?" ,NumeroPregunta = 12, TipoPregunta = "Likkert",Opciones=OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Vacaciones colectivas?", NumeroPregunta = 13, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Servicio de restaurante y/o casino?", NumeroPregunta = 14, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Servicios fondos de empleados o cooperativa?", NumeroPregunta = 15, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Beneficios para el retiro?", NumeroPregunta = 16, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Beneficios pares el cuidado de la salud?", NumeroPregunta = 17, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Seguro de enfermedades críticas?", NumeroPregunta = 18, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Seguro de vida / muerte accidental?", NumeroPregunta = 19, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Beneficios por discapacidad?", NumeroPregunta = 20, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Seguro de mascotas?", NumeroPregunta = 21, TipoPregunta = "Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {
