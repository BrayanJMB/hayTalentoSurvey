    ...
    public class ModelSurvey
    {
        ...
        private static List<Pregunta> PreguntaMercadeo5()
        {
            var Preguntas = new List<Pregunta>
            {
                 ...
                 new Pregunta {NombrePregunta = "¿Cuánto gastó su empresa en total en beneficios en el último año fiscal?", NumeroPregunta = 24, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkertper16()},
                 new Pregunta {NombrePregunta = "¿Los empleados valoran su plan de beneficios?", NumeroPregunta = 25, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿El plan de beneficios mejora la atracción y retención?", NumeroPregunta = 26, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿El plan de beneficios mejora el compromiso del empleado con su trabajo?", NumeroPregunta = 27, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿El plan de beneficios moviliza el desempeño?", NumeroPregunta = 28, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta="¿Beneficios a la carta (escogencia de acuerdo con portafolio de productos)?", NumeroPregunta = 29, TipoPregunta = "Multiple Likkert",Opciones=OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Modelo de compensación flexible?", NumeroPregunta = 30, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 ...
                 new Pregunta {NombrePregunta = "¿Planes de ahorro contributivo?", NumeroPregunta = 31, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Pólizas de Seguros (Vida, Asistencia Médica Domiciliaria, otras)?", NumeroPregunta = 32, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta="¿Tiempo libre recompensado (día de cumpleaños, tarde libre los viernes, 24 / 31 diciembre y miércoles santo?" ,NumeroPregunta = 33, TipoPregunta = "Multiple Likkert",Opciones=OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Vacaciones colectivas?", NumeroPregunta = 34, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Servicio de restaurante y/o casino?", NumeroPregunta = 35, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Servicios fondos de empleados o cooperativa?", NumeroPregunta = 36, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Beneficios para el retiro?", NumeroPregunta = 37, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Beneficios pares el cuidado de la salud?", NumeroPregunta = 38, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Seguro de enfermedades críticas?", NumeroPregunta = 39, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Seguro de vida / muerte accidental?", NumeroPregunta = 40, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Beneficios por discapacidad?", NumeroPregunta = 41, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {NombrePregunta = "¿Seguro de mascotas?", NumeroPregunta = 42, TipoPregunta = "Multiple Likkert", Opciones = OpcionesLikkert1()},
                 new Pregunta {
